export const textHeroSection = {
	title:
		"Hello I'am <span>Víctor Manuel</span> Ordiales García. <br> <span>Full Stack Developer</span>.",
	description:
		"Desarrollador Full Stack con experiencia en tecnologías como React, Node, Express, MongoDB, entre otras. Apasionado por la tecnología y la programación.",
}
...
export const experiences = [
	{
		...
		description:
			"Realización de proyectos y evolutivos Frontend dentro del CMS Oracle Web Center Site (OWCS) para el cliente Naturgy. ",
	},
	{
		...
		description:
			"Relización de proyectos y evolutivos Full para el cliente Naturgy. Todo esto hacienco uso de Spring Framework para el Backend y OWCS como CMS.",
	},
	{
		title: "I + D",
